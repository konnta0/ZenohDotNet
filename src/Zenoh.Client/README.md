...
Zenoh.Client provides a modern, idiomatic .NET API for Zenoh, built on top of Zenoh.Native. It leverages .NET 8.0 features like async/await, IAsyncDisposable, record types, and more for a superior developer experience.
...
This will automatically install the required Zenoh.Native dependency.
...
## Comparison with Zenoh.Native

| Feature | Zenoh.Native | Zenoh.Client |
|---------|--------------|--------------|
