...
namespace Zenoh.Unity.Editor
{
    ...
    public static class ZenohUnityEditor
    {
        ...
        {
            Application.OpenURL("https://github.com/konnta0/ZenohForCSharp-internal");
        }
        ...
        private static void CheckNativeLibraries()
        {
            ...
            {
                message += "No native libraries found. Please install Zenoh.Native via NuGet for Unity.";
            }
