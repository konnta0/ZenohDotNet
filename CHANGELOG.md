...
### Fixed
- Include Unity `.meta` files for package documentation, manifests, top-level directories, and bundled license files
- Fail UPM package assembly when an asset is missing its `.meta` file

## [1.9.0.0] - 2026-06-01

### Changed
- Package versions now align with the embedded Zenoh runtime (`1.9.0.x` = Zenoh 1.9.0)
- Updated to Eclipse Zenoh Rust **1.9.0**
- Apache-2.0 license text and NOTICE bundled for native runtime redistribution
...
### Dependencies
- ZenohDotNet.Native >= 1.9.0.0 (via NuGet for Unity)
